    ...
    <div id="area-principal">
        ...
        <div class="area-postagens">
            <div class="postagem">
                ...
                <p>
                    Preï¿½o do etanol tem alta de quase 5% nos postos; litro do diesel tambï¿½m avanï¿½a, segundo ANP     
                </p>
        ...
        <div class="area-postagens">
            <div class="postagem">
                <h2>PreÃ§o mÃ©dio da gasolina sobe apÃ³s 15 quedas consecutivas, segundo ANP</h2>
                ...
                <p>
                    Valor mÃ©dio do litro do combustÃ­vel vendido nos postos do paÃ­s subiu para R$ 4,86 na semana de 9 a 15 de outubro.
                </p>
        ...
        <div class="area-postagens">
            <div class="postagem">
                <h2>Cerca de 10 postos de gasolina sÃ£o flagrados com preÃ§os abusivos em Porto Velho</h2>
                <span class="data-postagem">postado em 17 de outubro de 2022</span>
                ...
                <p>
                    OperaÃ§Ã£o da Sefin e Procon iniciou no domingo (16). Em alguns postos de gasolina, os preÃ§os abusivos tinham um aumento de 10%.
                </p>
        ...
        <div class="area-postagens">
            <div class="postagem">
                <h2>Gasolina tem reajuste de preÃ§o no estado do Rio de Janeiro</h2>
                <span class="data-postagem">postado em 17 de outubro de 2022</span>
                <img width="620px" src="https://pubimg.band.uol.com.br/files/bf9414075130ed67095c.webp" alt="">
                <p>
                    O aumento dos combustÃ­veis percebido por moradores do Rio.
                </p>
        ...
        <div class="area-postagens">
            <div class="postagem">
                <h2>P-71 produzirÃ¡ atÃ© 150 mil barris/dia de petrÃ³leo na Bacia de Santos</h2>
                <span class="data-postagem">postado em 17 de outubro de 2022</span>
                ...
                <p>
                    A entrada em operaÃ§Ã£o da P-71 estÃ¡ prevista para dezembro deste ano, devendo atingir o pico de produÃ§Ã£o atÃ© o fim de 2023. 
                </p>
